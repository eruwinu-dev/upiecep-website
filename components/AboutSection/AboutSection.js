...
const AboutSection = () => {
	return (
		<div
			className="box-border h-max min-h-screen flex flex-grow flex-col justify-start lg:pt-20 pt-14 ..."
			id="about">
			<span className="w-screen lg:text-4xl text-2xl text-center font-bold lg:mb-10 mb-4">
				What is UP IECEP?
			</span>
			...
			<div className="h-max grid lg:grid-cols-2 grid-cols-1 grid-flow-row gap-x-10 gap-y-5 lg:px-40 px-6 pt-10 lg:pb-4 pb-10">
